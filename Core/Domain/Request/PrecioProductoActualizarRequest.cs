...
{
    public class PrecioProductoActualizarRequest
    {       
...
public class PrecioProductoActualizarRequestValidator : AbstractValidator<PrecioProductoActualizarRequest>
{
    public PrecioProductoActualizarRequestValidator()
    {
        RuleFor(x => x.Lista)
        ...
        RuleFor(x => x.CodigoPrecio)
           .GreaterThan(0).WithMessage("El código precio debe ser mayor a 0.");
