...
public class ClienteDatosPersonalesActualizarRequest
{    
...
public class ClienteDatosPersonalesActualizarRequestValidator : AbstractValidator<ClienteDatosPersonalesActualizarRequest>
{
    public ClienteDatosPersonalesActualizarRequestValidator()
    {
